          ...
          <div className="  partalarm ">
            <div  className=" d-flex  ">
              <div  className=" d-flex   ">
                ...
                <h6 className=" ms-2 mt-4 ">{secure==1? <p>an intruder detected </p>:<p>your home is secure </p>}</h6>
              </div>
              <div  className=" d-flex   ">
                <button  onTouchStart={decorate} className="btn border-0 ">
                    <div>{secure==1 ? (  <img className="alarm" src={ninja} alt="" />) : (  <img className="alarm" src={Secure} alt="" />)}</div>
            ...
            <div  className=" d-flex   ">
                ...
                <h6 className=" ms-2  mt-4">{planting==1024? <p className="alarming">your plant needs water </p>: <p> your plant is filled with water don't worry</p>} </h6>
              </div>
               <div  className=" d-flex   ">
                <button onTouchStart={decorate} className="btn  border-0">
                    <div>{!m ? (  <img className="alarm" src={nino} alt="" />) : (  <img className="alarm" src={secursuccesfully} alt="" />)}</div>
                </button>
                <h6 className=" ms-2 mt-4">secure</h6>
              </div>
